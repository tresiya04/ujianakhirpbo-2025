...
class JudulPolicy
{
    ...
    {
        return $user->can('view_any_judul');
    }
    ...
    {
        return $user->can('delete_any_judul');
    }
     ...
     */
    public function replicate(User $user, Judul $judul): bool
    {
